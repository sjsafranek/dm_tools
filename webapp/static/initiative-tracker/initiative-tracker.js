...
(function(DM){
    ...
    */
    ...
    var InitativeTrackerUi = function() {
        ...
        var initativeTracker = new InitativeTracker();
        ...
        var addCharacterButton = $("<button>")
            ...
            .on("click", function(){
                ...
                initativeTracker.add(characterName, characterInitative);

                characterInitativeContainer.empty();
                characterInitativeContainer.append(
                    initativeTracker._order.map(function(d, i){
                        return $("<li>")
                            .addClass("list-group-item d-flex justify-content-between align-items-center " + (d.active ? "" : "disabled") + " " + (initativeTracker.index==i ? "list-group-item-primary": ""))
                            .append(
                                d.name,
                                ...
                                $("<button>")
                                    ...
                                    .on("click", function(){
                                        initativeTracker.remove(d.name);
    ...
    DM.registerTool("InitativeTracker", InitativeTrackerUi);
